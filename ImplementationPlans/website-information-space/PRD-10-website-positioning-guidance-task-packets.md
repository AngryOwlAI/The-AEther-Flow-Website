# Codex Task Packets: PRD-10 Website Positioning Guidance

Source plan:
`ImplementationPlans/website-information-space/PRD-10-website-positioning-guidance-implementation-plan.md`
...
## Task PRD-10-TASK-01: Prepare Source Bundle And Page Contract

### Goal

Prepare source-bundle and page-contract guidance for positioning and public-language.

### Context

- PRD requirements: `PRD-10` traceability rows in the source implementation
  plan.
- Relevant future routes: `/`, `/physics/`, `/ai-research-system/`, `/resources/`.
- Existing patterns: canonical greenfield route model, substantial intro
  paragraph rule, source-bundle-first public copy, and owner review.
...
## Task PRD-10-TASK-02: Implement Greenfield Route Slice

### Goal

Implement the affected greenfield route surface for positioning and public-language.

### Context

- PRD requirements: `PRD-10` functional requirements.
- Relevant future routes: `/`, `/physics/`, `/ai-research-system/`, `/resources/`.
...
- Prefer narrative bands, evidence rails, dossiers, matrices, tables,
  timelines, glossaries, and diagrams when they fit the information type.
- Use ordinary cards only for true peer choices, catalogues, inventories, or
  galleries.
- Keep provenance visible but secondary to internal website navigation.

### Acceptance criteria

- [ ] The route slice satisfies the mapped `PRD-10` requirements.
...
The route slice is technically valid, source-bundled, and marked for owner
review.

## Task PRD-10-TASK-03: Validate, Review, And Prepare Handoff

### Goal

Close the implementation work for positioning and public-language with validation evidence,
owner-review status, and a clear next packet.

### Context

- PRD requirements: `PRD-10` acceptance criteria and validation plan.
- Relevant future routes: `/`, `/physics/`, `/ai-research-system/`, `/resources/`.
- Existing patterns: implementation-control completion record and handoff
  closeout.

### Constraints

- Do not mark owner acceptance unless the owner has reviewed and accepted the
  route set.
...
- For public route work, also use the future route validation profile from this
  task-packet file.

### Done when

The packet can be checkpointed locally without push, deploy, or source-refresh
side effects.
