# Codex Task Packets: PRD-09 Current Research Frontier for Website Use

Source plan:
`ImplementationPlans/website-information-space/PRD-09-current-research-frontier-for-website-use-implementation-plan.md`
...
## Task PRD-09-TASK-01: Prepare Source Bundle And Page Contract

### Goal

Prepare source-bundle and page-contract guidance for current-frontier snapshots, blocked claims, and stale-data behavior.

### Context

- PRD requirements: `PRD-09` traceability rows in the source implementation plan.
- Relevant future routes: `/ai-research-system/current-state/`, `/physics/claim-status/`, `/physics/open-burdens/`.
...
## Task PRD-09-TASK-02: Implement Greenfield Route Slice

### Goal

Implement the affected greenfield route surface for current-frontier snapshots, blocked claims, and stale-data behavior.

### Context

- PRD requirements: `PRD-09` functional requirements.
- Relevant future routes: `/ai-research-system/current-state/`, `/physics/claim-status/`, `/physics/open-burdens/`.
...
- [ ] The route slice satisfies the mapped `PRD-09` requirements.
...
## Task PRD-09-TASK-03: Validate, Review, And Prepare Handoff

### Goal

Close the implementation work for current-frontier snapshots, blocked claims, and stale-data behavior with validation evidence, owner-review status, and a clear next packet.

### Context

- PRD requirements: `PRD-09` acceptance criteria and validation plan.
- Relevant future routes: `/ai-research-system/current-state/`, `/physics/claim-status/`, `/physics/open-burdens/`.
