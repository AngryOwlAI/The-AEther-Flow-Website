# Codex Task Packets: PRD-08 Folder and Repository Topology Components

Source plan:
`ImplementationPlans/website-information-space/PRD-08-folder-and-repository-topology-components-implementation-plan.md`
...
## Task PRD-08-TASK-01: Prepare Source Bundle And Page Contract

### Goal

Prepare source-bundle and page-contract guidance for repository topology, folder families, and generated-versus-canonical boundaries.

### Context

- PRD requirements: `PRD-08` traceability rows in the source implementation plan.
- Relevant future routes: `/resources/repository-map/`, `/resources/site-builder-guide/`.
...
## Task PRD-08-TASK-02: Implement Greenfield Route Slice

### Goal

Implement the affected greenfield route surface for repository topology, folder families, and generated-versus-canonical boundaries.

### Context

- PRD requirements: `PRD-08` functional requirements.
- Relevant future routes: `/resources/repository-map/`, `/resources/site-builder-guide/`.
...
- [ ] The route slice satisfies the mapped `PRD-08` requirements.
...
## Task PRD-08-TASK-03: Validate, Review, And Prepare Handoff

### Goal

Close the implementation work for repository topology, folder families, and generated-versus-canonical boundaries with validation evidence, owner-review status, and a clear next packet.

### Context

- PRD requirements: `PRD-08` acceptance criteria and validation plan.
- Relevant future routes: `/resources/repository-map/`, `/resources/site-builder-guide/`.
