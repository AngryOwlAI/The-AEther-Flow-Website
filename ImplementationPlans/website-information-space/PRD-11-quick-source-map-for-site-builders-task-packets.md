# Codex Task Packets: PRD-11 Quick Source Map for Site Builders
...
## Task PRD-11-TASK-01: Prepare Source Bundle And Page Contract

### Goal

Prepare source-bundle and page-contract guidance for source map, page-to-source checklist, and site-builder handoff.

### Context

- PRD requirements: `PRD-11` traceability rows in the source implementation plan.
- Relevant future routes: `/resources/site-builder-guide/`, `/resources/reading-paths/`, `/resources/repository-map/`.
...
## Task PRD-11-TASK-02: Implement Greenfield Route Slice

### Goal

Implement the affected greenfield route surface for source map, page-to-source checklist, and site-builder handoff.

### Context

- PRD requirements: `PRD-11` functional requirements.
- Relevant future routes: `/resources/site-builder-guide/`, `/resources/reading-paths/`, `/resources/repository-map/`.
...
- [ ] The route slice satisfies the mapped `PRD-11` requirements.
...
## Task PRD-11-TASK-03: Validate, Review, And Prepare Handoff

### Goal

Close the implementation work for source map, page-to-source checklist, and site-builder handoff with validation evidence, owner-review status, and a clear next packet.

### Context

- PRD requirements: `PRD-11` acceptance criteria and validation plan.
- Relevant future routes: `/resources/site-builder-guide/`, `/resources/reading-paths/`, `/resources/repository-map/`.
