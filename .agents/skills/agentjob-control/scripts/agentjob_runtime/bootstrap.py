...
human_gates:
  protected_actions: [public-release, production-deployment, secret-access, policy-change, irreversible-external-action, repository-branch-create, repository-worktree-create, repository-binding-change]
"""
